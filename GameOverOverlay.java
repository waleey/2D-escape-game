...
public class GameOverOverlay {
	...
	private void createUrmButtons() {
		...
		int exitX = (int) (462 * Game.SCALE);
		int bY = (int) (325 * Game.SCALE);

		menuB = new UrmButton(menuX, bY, Constants.UI.URMButtons.URM_SIZE, Constants.UI.URMButtons.URM_SIZE, 2);
		exitB = new UrmButton(exitX, bY, Constants.UI.URMButtons.URM_SIZE, Constants.UI.URMButtons.URM_SIZE, 0);

	}

	private void loadBackground() {
		backgroundImg = LoadSave.GetSpriteAtlas(LoadSave.GAME_OVER);
